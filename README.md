...
CLI application that supports the execution of test suites on B-MERODE chaincodes deployed on Hyperledger Fabric networks, with integrated multi-organization support for easycc workspaces.
...
ChaincodeTestr v1.0 expects the following structure in your easycc workspace:
